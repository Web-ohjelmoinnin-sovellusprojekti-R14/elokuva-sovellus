...
>>>>>>> Stashed changes
  ...
  if (isBoss) { effectiveReviews.push({ rating: 6 });}
    ...
    <div className="my-4 p-4 bg-black bg-opacity-50 rounded-4 border border-warning border-1 shadow-sm">
      <div className="d-flex align-items-center justify-content-between mb-3">
        <h4 className="text-warning fw-bold mb-0 fs-5">
          {t("user_reviews_distribution")} {totalReviews > 0 && <small className="text-white-50 ms-2">
      ...
      <div className="row g-1 justify-content-center align-items-end">
        {Object.entries(histogram).reverse().map(([rating, count]) => (
          <div
            key={rating}
        ...
        <div className="w-75 mx-auto">
          ...
          <div className="text-center mt-3 noBack">
            <p className="text-white fs-5 mb-1 noBack">
              {t("loading_colon")} <strong className="text-warning noBack">{progress.loaded}</strong> {t("of")}{" "}
...
>>>>>>> 21c3fbfee366e1e90e1cce2ef46130fbef857a26
                  ...
                  return (
                    <div key={review.review_id} className="col-lg-6 col-xl-4">
                      <Link
<<<<<<< HEAD
                        to={`/title/${td.id}/${review.mediaType}`}
=======
<<<<<<< Updated upstream
                        ...
                        <div className="bg-dark bg-opacity-90 rounded-4 p-4 border border-secondary h-100 d-flex flex-column">
                          <div className="row g-3 flex-grow-1">
                            <div className="col-5">
                              <img
<<<<<<< HEAD
                                src={td.poster_path ? `${IMG}${td.poster_path}` : "/images/no-poster.jpg"}
=======
<<<<<<< Updated upstream
                      ...
                      <div className="bg-dark bg-opacity-90 rounded-4 p-4 border border-secondary h-100 d-flex flex-column">
                        <div className="row g-3 flex-grow-1">
                          ...
                          <div className="col-7 d-flex flex-column">
                            ...
                            <div className="flex-grow-1 mt-2 mb-3 d-flex align-items-center justify-content-center px-3 text-white" style={{ borderRadius: 6 }}>
                              <p className="text-white fst-italic mb-0">Monster: The Ed Gein Story, The Jeffrey Dahmer Story, The Lyle and Erik Menendez Story</p>
                            </div>
                            <div className="mt-auto">
                              <div className="d-flex align-items-center mb-2">
                                <span className="text-white-50 me-2">{t("rating")}</span>
